...
export class Clmm extends Base {
    ...
    static getAmountsFromLiquidity({ poolInfo, tickLower, tickUpper, liquidity, slippage, add, token2022Infos, epochInfo, }) {
        ...
        const [amountSlippageA, amountSlippageB] = [
            getTransferAmountFee(new BN(new Decimal(amounts.amountA.toString()).mul(coefficientRe).toFixed(0)), token2022Infos[poolInfo.mintA.mint.toString()]?.feeConfig, epochInfo, true),
            getTransferAmountFee(new BN(new Decimal(amounts.amountB.toString()).mul(coefficientRe).toFixed(0)), token2022Infos[poolInfo.mintB.mint.toString()]?.feeConfig, epochInfo, true),
        ];
        return {
            liquidity,
            amountA,
