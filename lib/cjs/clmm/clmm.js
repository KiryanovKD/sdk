...
class Clmm extends base_1.Base {
    ...
    static getAmountsFromLiquidity({ poolInfo, tickLower, tickUpper, liquidity, slippage, add, token2022Infos, epochInfo, }) {
        ...
        const [amountSlippageA, amountSlippageB] = [
            (0, base_1.getTransferAmountFee)(new bn_js_1.default(new decimal_js_1.default(amounts.amountA.toString()).mul(coefficientRe).toFixed(0)), (_c = token2022Infos[poolInfo.mintA.mint.toString()]) === null || _c === void 0 ? void 0 : _c.feeConfig, epochInfo, true),
            (0, base_1.getTransferAmountFee)(new bn_js_1.default(new decimal_js_1.default(amounts.amountB.toString()).mul(coefficientRe).toFixed(0)), (_d = token2022Infos[poolInfo.mintB.mint.toString()]) === null || _d === void 0 ? void 0 : _d.feeConfig, epochInfo, true),
        ];
        return {
            liquidity,
            amountA,
